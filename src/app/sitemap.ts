...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { path: "/corporate-partners", priority: 0.9, changeFrequency: "monthly" as const },
    { path: "/institutional-funding", priority: 0.9, changeFrequency: "monthly" as const },
    { path: "/invest", priority: 0.9, changeFrequency: "monthly" as const },
