...
import { JsonLd, veteransServiceSchema, createBreadcrumbSchema } from "@/components/seo";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Veterans & First Responders | New Horizons Foundation",
    description:
      "Specialized mental health support for veterans, law enforcement, firefighters, EMTs, and their families.",
  },
  alternates: {
    canonical: "/programs/veterans-first-responders",
  },
};
...
const breadcrumbs = createBreadcrumbSchema([
  ...
  { name: "Veterans & First Responders", url: "https://newhorizonsfoundation.org/programs/veterans-first-responders" },
]);
...
export default function VeteransFirstRespondersPage() {
  return (
    <>
      <JsonLd data={[veteransServiceSchema, breadcrumbs]} />
      <Header />
      <main className="flex-1">
        {/* Hero Section */}
        <section className="bg-gradient-to-r from-foundation-blue to-sky-blue text-white py-24 md:py-32">
